...
Pebble.addEventListener('showConfiguration', function(e) {
  var uri = 'http://www.themapman.com/pebblewatch/nographics_weather.html?' +
    ...
    '&mmode=' + encodeURIComponent(options['mmode']);
